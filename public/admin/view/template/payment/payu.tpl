      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-payu" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="payu_security" value="<?php echo $payu_security; ?>" placeholder="<?php echo $entry_security; ?>" id="input-security" class="form-control" />
          ...
          <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="payu_test" id="input-live-demo" class="form-control">
                    <?php if ($payu_test) { ?>

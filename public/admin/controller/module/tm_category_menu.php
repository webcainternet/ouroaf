...
class ControllerModuleTmCategoryMenu extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('tm_category_menu', $this->request->post);
		...
		if (isset($this->request->post['tm_category_menu_status'])) {
			$data['tm_category_menu_status'] = $this->request->post['tm_category_menu_status'];
		} else {
			$data['tm_category_menu_status'] = $this->config->get('tm_category_menu_status');
		}
